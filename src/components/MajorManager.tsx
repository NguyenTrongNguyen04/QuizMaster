...
import { Plus, Edit, Trash2, BookOpen, FileText, Users, ChevronRight, GraduationCap, BookOpen as BookOpenIcon, FileText as FileTextIcon } from 'lucide-react';
...
const MajorManager: React.FC<MajorManagerProps> = ({ userRole }) => {
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-200">
          ...
          <div className="p-6">
            {selectedSubject ? (
              <div className="space-y-3">
                {exams[selectedSubject]?.map((exam) => (
                  <div
                    key={exam.id}
                ...
                {(!exams[selectedSubject] || exams[selectedSubject].length === 0) && (
                  <div className="text-center py-8 text-gray-500">
