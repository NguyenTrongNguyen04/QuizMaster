...
const Quiz: React.FC<QuizProps> = ({ subjects, onQuizComplete, user }) => {
  ...
  const startQuiz = () => {
    ...
    // Always show all questions, limit access will be handled in the interface
    // Remove custom quiz size limitation for now
    
    setQuizQuestions(finalQuestions);
    setTimeLeft(selectedExam.timeLimit || 3600); // Default 1 hour
  ...
  const handleFinishQuiz = () => {
    if (!startTime || !selectedExam) return;
              ...
              <div className="mb-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 max-w-md mx-auto">
                  ...
                  <div className="bg-purple-50 p-4 rounded-lg">
                    <div className="text-2xl font-bold text-purple-600">{Math.round((quizQuestions.length / (timeLeft / 60)))}</div>
